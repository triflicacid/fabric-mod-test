...
import net.triflicacid.first.block.custom.*;
...
public class ModBlocks {
    ...
    public static final Block RAPESEED_CROP = registerBlock("rapeseed_crop", new RapeseedCropBlock(FabricBlockSettings.copy(Blocks.WHEAT)));
